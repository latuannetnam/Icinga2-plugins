...
# ----------------- print result -------------------------
my $result_msg="OK: zimbra-stats |";
$result_msg = $result_msg . " received=" . ($msgsRcvd // 0); 
$result_msg = $result_msg . " delivered=" . $msgsDlvrd ;
$result_msg = $result_msg . " forwarded=" . ($msgsFwdd // 0);
$result_msg = $result_msg . " deferred=" . ($msgsDfrd // 0);
$result_msg = $result_msg . " bounced=" . ($msgsBncd // 0);
$result_msg = $result_msg . " rejected=" . ($msgsRjctd // 0);
$result_msg = $result_msg . " rejected_pct=" . ($msgsRjctdPct // 0);
$result_msg = $result_msg . " reject_warnings=" . ($msgsWrnd // 0);
$result_msg = $result_msg . " held=" . ($msgsHld // 0);
$result_msg = $result_msg . " discarded=" . ($msgsDscrdd // 0);
$result_msg = $result_msg . " discarded_pct=" . ($msgsDscrddPct // 0);
$result_msg = $result_msg . " bytes_received=" . ($sizeRcvd // 0);
$result_msg = $result_msg . " bytes_delivered=" . ($sizeDlvrd // 0);
$result_msg = $result_msg . " senders=" . ($sendgUserCnt // 0);
$result_msg = $result_msg . " sending_hosts_domains=" . ($sendgDomCnt // 0);
$result_msg = $result_msg . " recipients=" . ($recipUserCnt // 0);
$result_msg = $result_msg . " recipient_hosts_domains=" . ($recipDomCnt // 0);
...
if(defined($opts{'smtpdStats'})) {
	$result_msg = $result_msg . " connections=" . ($smtpdConnCnt // 0);
	$result_msg = $result_msg . " hosts_domains=" . int(keys %smtpdPerDom);
